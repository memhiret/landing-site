<template>
    ...
    >
        <div class="flex flex-col gap-8 items-center">
            <div
                class="my-4 px-4 flex flex-col gap-6 lg:gap-12 items-center justify-center text-center"
            >
                <p
                    class="font-body font-medium responsive-subheading lg:tracking-wider"
                >
                    No More Test Anxiety,
                </p>
                <p
                    class="font-body font-medium responsive-heading lg:tracking-wide"
                >
        ...
        <div class="flex flex-col gap-2 md:gap-4 lg:gap-6 items-center">
            ...
            <p class="font-body text-2xs md:text-sm lg:text-base">
                and more...
            </p>
        </div>
    </div>
