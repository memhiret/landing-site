<template>
    ...
    <div class="mt-28 md:mt-32 lg:mt-44 responsive-px py-4 col-flex">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p>
                        We are committed to providing world-class and easily
                        accessible education, creating a learning environment
                        where students are challenged but manage to flourish and
                        grow.
                    </p>
                    <p>
                        We believe that education is the key to a better future,
                        and we are committed to playing our role in creating a
                        more equitable landscape.
                    </p>
                </div>
            </div>
            <SvgoGraduation
                class="md:basis-1/2 icon-rm-mg text-13xl mobm:text-14xl md:text-16xl"
                filled
            />
        </div>
        <div
        ...
        >
            ...
            <div
                class="flex flex-col gap-4 font-body font-normal text-sm xl:text-lg"
            >
                <p>
                    To be the lead of quality education, equipping students with
                    the skills, knowledge and values required to thrive in
                    real-word scenarios.
                </p>
                <p>
                    We envision a world where everyone has easy access to
                    impact-driven, world-class education.
                </p>
            </div>
        </div>
        ...
        >
            ...
            >
                <p
                    class="w-full font-display font-semibold text-left text-3xl lg:text-4xl xl:text-6xl"
                >
                    Careers
                </p>
                <SvgoCareers
                    class="icon-rm-mg text-14xl md:text-12xl xl:text-16xl"
                    filled
                />
            </div>
            <div class="basis-1/2 flex flex-col gap-8 md:gap-10">
                <p
                    class="font-body font-normal text-sm xl:text-lg xl:leading-10 text-left"
                >
                    We're always on the lookout for passionate individuals to
                    join our ever-growing team, whether you're an experienced
                    professional or just starting your career journey.<span
                        class="hidden md:inline-block"
                        >We foster a dynamic and collaborative environment where
                        you can learn, grow, and make a real impact.</span
                    >
                </p>
