  ...
  <div class="mt-28 md:mt-32 lg:mt-44 responsive-px py-4 md:py-6 lg:py-16 col-flex">
    ...
    >
      ...
      >
        ...
        <p
          class="desc-text text-base md:text-lg lg:text-xl xl:text-2xl text-center leading-loose"
        >
      ...
      <div class="col-flex gap-8 md:gap-12 lg:gap-16 xl:gap-20">
        ...
        >
          <SvgoInnovation
            class="md:basis-1/2 icon-rm-mg text-12xl xl:text-14xl"
            filled
          />
          <div class="md:basis-1/2 flex flex-col items-start gap-4 md:gap-8">
            <p
              class="font-body font-semibold text-lg md:text-2xl lg:text-3xl xl:text-4xl"
            >
              Innovation
            </p>
            <p
            ...
            >
              We encourage creative thinking and bold ideas to develop
              cutting-edge solutions that transform learning experiences.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="md:basis-1/2 flex flex-col items-start gap-4 md:gap-8">
            ...
            <p
              class="font-body font-normal text-sm md:text-base lg:text-lg xl:text-xl leading-10 lg:leading-loose xl:leading-loose"
            >
              Make a real difference in the lives of others. At MemhirET, your
              work directly contributes to empowering learners and educators
              around the world.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div class="md:basis-1/2 flex flex-col items-start gap-4 md:gap-8">
            ...
            <p
              class="font-body font-normal text-sm md:text-base lg:text-lg xl:text-xl leading-10 lg:leading-loose xl:leading-loose"
            >
              We foster a collaborative environment where diverse perspectives
    ...
    >
      ...
      <p class="desc-text text-base xl:text-lg">
        Ooops. We don't have any openings at the moment. If you'd like to get
        notified of future openings, fill out the form below.
      </p>
        ...
        <div class="w-full flex flex-col items-start gap-6 xl:gap-10">
          <div class="w-full flex flex-col md:flex-row items-start gap-6">
            <div class="w-full md:basis-1/2">
              <label
                for="firstname"
                class="block font-body font-medium text-sm xl:text-lg"
                >First Name
              </label>
