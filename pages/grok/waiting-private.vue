<template>
    <div
        class="mt-28 md:mt-32 lg:mt-40 xl:mt-44 mb-8 responsive-px py-4 col-flex"
    >
        <div class="col-flex lg:flex-row xl:w-11/12 gap-8 xl:gap-12">
            <div class="md:basis-1/2 col-flex gap-4">
                ...
                <p
                    class="w-11/12 md:w-1/2 lg:w-9/12 font-body font-normal text-center text-xs md:text-sm xl:text-lg lg:tracking-wide leading-relaxed"
                >
...
export default {
    ...
    data() {
        return {
            buttonClass2:
                "mt-4 w-10/12 py-3 px-2 sm:py-4 sm:px-3 font-body sm:text-sm md:text-base lg:text-lg main-button hover:main-hover",
            buttonText2: "Join Waitlist",
            buttonLink2: "/",
        };
    },
};
